...
const CitizenProfile = () => {
 ...
 const handleSubscribe = async () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 px-4 py-10 md:py-16">
      <div className="max-w-7xl mx-auto space-y-4 md:space-y-8">
        {/* Blocked Warning */}
        {isBlocked && (
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-red-50 to-red-100 border-l-4 border-red-500 p-3 md:p-6 shadow-xl animate-pulse">
            <div className="flex items-center md:items-start gap-4">
              ...
              <div>
                <h3 className=" text-sm md:text-lg font-bold text-red-800 md:mb-1">Account Blocked</h3>
        ...
        {/* Welcome Hero Banner */}
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-4 md:p-12 shadow-xl">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-4 md:gap-8">
            <div className="flex-1 text-center md:text-left space-y-2 md:space-y-4">
              ...
              <div className="flex items-center md:items-start md:gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-2 md:p-4 border border-white/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
          {[
            ...
            <div
              key={idx}
              className="group relative overflow-hidden rounded-xl bg-white/70 backdrop-blur-xl p-3 md:p-6 shadow-lg border border-white/20 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`inline-flex p-2 md:p-4 rounded-lg bg-gradient-to-br ${card.gradient} text-white shadow-lg md:mb-4`}>
                  {card.icon}
                </div>
                <h3 className="text-xl font-bold text-slate-800 md:mb-3">
                  {card.title}
                </h3>
        ...
        {/* Profile Card */}
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 p-4 md:p-8 shadow-xl">
          <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-white/5 rounded-full blur-3xl"></div>
          
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-4 md:gap-8">
            <div className="relative group">
            ...
            <div className="flex-1 text-center lg:text-left space-y-3">
              ...
              <p className="text-white/80 text-sm md:text-base bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
