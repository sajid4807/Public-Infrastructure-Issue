              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit(handleLogin)}>
                  <div className="space-y-3 md:space-y-5">
                    ...
                    {/* Login Button */}
                    <button className="relative cursor-pointer w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white font-black py-3 rounded-xl shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 overflow-hidden group">
                    ...
                    <div className="space-y-2 pt-3">
                      <p className="text-xs text-center text-slate-500 font-semibold uppercase tracking-wide">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <button
                          ...
                          className="px-3 cursor-pointer py-2 md:py-4 bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300 text-blue-800 font-bold text-xs rounded-lg transition-all hover:scale-105 shadow-sm"
                        >
                          👨‍💼 Admin
                        </button>
                        ...
                        <button
                          ...
                          className="px-3 cursor-pointer py-2 md:py-4 bg-gradient-to-br from-green-100 to-green-200 hover:from-green-200 hover:to-green-300 text-green-800 font-bold text-xs rounded-lg transition-all hover:scale-105 shadow-sm"
                        >
                          👤 Citizen
                        </button>
                        ...
                        <button
                          ...
                          onClick={() => {
                            const demoData = {
                              email: "shole@gmail.com",
                              password: "$#@Jid4807",
                            };
                            reset(demoData);
                            handleSubmit(handleLogin)(demoData);
                          }}
                          className="px-3 cursor-pointer py-2 md:py-4 bg-gradient-to-br from-purple-100 to-purple-200 hover:from-purple-200 hover:to-purple-300 text-purple-800 font-bold text-xs rounded-lg transition-all hover:scale-105 shadow-sm"
                        >
                          👷 Staff
                        </button>
                      </div>
