    ...
    <section className="py-10 md:py-20">
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="text-center mb-8 md:mb-16">
          <div className="inline-flex items-center gap-2 bg-indigo-100 px-4 py-2 rounded-full mb-2 md:mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-lg bg-white/70 backdrop-blur-xl border border-white/20 p-4 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
            ...
            >
              ...
              {/* Glow effect */}
              <div className={`absolute -top-20 -right-20 w-40 h-40 bg-${feature.bgGlow}-400/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>

              <div className="relative z-10 space-y-1 md:space-y-4">
                {/* Icon */}
                <div className={`inline-flex p-2 md:p-4 bg-gradient-to-br ${feature.gradient} rounded-lg text-white shadow-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                ...
                {/* Content */}
                <div>
                  <h3 className="text-xl font-bold text-slate-800 md:mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-indigo-600 group-hover:to-purple-600 transition-all duration-300">
                    {feature.title}
                  </h3>
        ...
        {/* Bottom decoration */}
        <div className="flex justify-center mt-6 md:mt-16 gap-2">
