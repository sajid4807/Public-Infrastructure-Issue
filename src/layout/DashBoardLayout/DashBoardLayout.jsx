  ...
  return (
    <div className="drawer lg:drawer-open">
          ...
          <div className="navbar px-4 lg:px-8">
            ...
            <div className="flex-1">
              <Link
                ...
                className="text-lg md:text-2xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent hover:scale-105 transition-transform"
              >
      ...
      <div className="drawer-side z-40">
        ...
        ></label>
        <div className="flex min-h-full flex-col bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 is-drawer-close:w-25 is-drawer-open:w-72 shadow-2xl border-r border-indigo-900/20">
          {/* Sidebar content */}
          <ul className="menu w-full grow p-4 space-y-2">
            ...
            {role === "staff" && (
              <>
                <li>
                  ...
                  >
                    <HiCollection size={24} className="is-drawer-close:mx-auto" />
                    <span className="is-drawer-close:hidden text-lg font-medium">
                      Assigned Issues
                    </span>
                  </NavLink>
            ...
            <li className="mt-auto">
              <button
                className="is-drawer-close:tooltip is-drawer-close:tooltip-right rounded-xl text-slate-300 hover:bg-red-500/20 hover:text-red-400 transition-all duration-300 hover:scale-105"
                data-tip="Log out"
                onClick={handleLogout}
              >
                <TbLogout size={24} className="is-drawer-close:mx-auto" />
                <span className="is-drawer-close:hidden text-lg font-medium">
                  Log out
                </span>
              </button>
